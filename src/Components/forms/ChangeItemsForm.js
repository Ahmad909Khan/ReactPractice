...
function ChangeItemsForm(props) {
    ...
    useEffect(() => {
        itemNameRef.current.value = props.currentItem.itemName;
        itemCostRef.current.value = props.currentItem.cost;
        itemQuantityRef.current.value = props.currentItem.quantity;
